...
![Zustand](https://img.shields.io/badge/Zustand-4B3621?style=for-the-badge)
...
Integro IA en el flujo diario de desarrollo para acelerar iteraciones, mejorar documentación técnica y reducir tiempos de entrega sin comprometer calidad.

- Uso AI skills/agents para tareas puntuales de análisis, refactorización guiada y generación de borradores técnicos.
- Manejo OpenCode como herramienta de soporte para ejecución asistida, revisión de cambios y productividad en tareas repetitivas.
- Aplico un enfoque de uso responsable: la IA acelera el delivery, pero las decisiones finales se sostienen con criterio técnico, validaciones y pruebas.
